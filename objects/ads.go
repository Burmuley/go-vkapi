...
func (a *AdsAccessRole) String() string {
	return string(*a)
}
...
func (a *AdsAccountType) String() string {
	return string(*a)
}
...
func (a *AdsAdApproved) String() string {
	switch *a {
	case 0:
...
func (a *AdsAdCostType) String() string {
	switch *a {
	case 0:
		return "per clicks"
	case 1:
...
func (a *AdsAdLayoutCostType) String() string {
	switch *a {
	case 0:
		return "per clicks"
	case 1:
...
func (a *AdsAdStatus) String() string {
	switch *a {
	case 0:
		return "stopped"
	case 1:
...
func (c *AdsCampaignStatus) String() string {
	switch *c {
	case 0:
		return "stopped"
	case 1:
...
func (c *AdsCampaignType) String() string {
	return string(*c)
}
...
func (c *AdsCriteriaSex) String() string {
	switch *c {
	case 0:
		return "any"
	case 1:
...
func (o *AdsObjectType) String() string {
	return string(*o)
}
...
func (s *AdsStatsSexValue) String() string {
	switch *s {
	case "f":
		return "female"
	case "m":
...
func (t *AdsTargSuggestionsSchoolsType) String() string {
	return string(*t)
}
