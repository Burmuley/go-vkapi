...
// PhotosMarketAlbumUpload type represents `photos_market_album_upload_response` API object
type PhotosMarketAlbumUpload struct {
...
// PhotosMarketUpload type represents `photos_market_upload_response` API object
type PhotosMarketUpload struct {
...
// PhotosMessageUpload type represents `photos_message_upload_response` API object
type PhotosMessageUpload struct {
	Hash   string `json:"hash"`   // Uploading hash
	Photo  string `json:"photo"`  // Uploaded photo data
	Server int    `json:"server"` // Upload server number
}

// PhotosOwnerUpload type represents `photos_owner_upload_response` API object
type PhotosOwnerUpload struct {
	Hash   string `json:"hash"`   // Uploading hash
	Photo  string `json:"photo"`  // Uploaded photo data
	Server int    `json:"server"` // Upload server number
}
...
// PhotosPhotoUpload type represents `photos_photo_upload_response` API object
type PhotosPhotoUpload struct {
...
// PhotosWallUpload type represents `photos_wall_upload_response` API object
type PhotosWallUpload struct {
	Hash   string `json:"hash"`   // Uploading hash
	Photo  string `json:"photo"`  // Uploaded photo data
	Server int    `json:"server"` // Upload server number
}
