...
// BoardDefaultOrder represents `board_default_order` API object
...
// BoardTopic represents `board_topic` API object
...
// BoardTopicComment represents `board_topic_comment` API object
type BoardTopicComment struct {
	Attachments []WallCommentAttachments `json:"attachments"`
	Date        int                      `json:"date"`
...
// BoardTopicPoll represents `board_topic_poll` API object
